...
prevalence_msm_whamp <- function(dat, at) {
  ...
  dat$epi$num.18to24[at] <- sum(age >= 18 & age <25)
  dat$epi$num.25to29[at] <- sum(age >= 25 & age <30)
  dat$epi$num.30to34[at] <- sum(age >= 30 & age <35)
  dat$epi$num.35to39[at] <- sum(age >= 35 & age <40)
  dat$epi$num.40to44[at] <- sum(age >= 40 & age <45)
  dat$epi$num.45to49[at] <- sum(age >= 45 & age <50)
  dat$epi$num.50to54[at] <- sum(age >= 50 & age <55)
  dat$epi$num.55to59[at] <- sum(age >= 55)
