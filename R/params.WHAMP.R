...
param_msm_whamp <- function(nwstats,
                      ...
                      tt.traj.KC.B.prob = c(0.080*(1-0.839), 0.080*(0.839), (1-0.081)*(1-0.839), (1-0.081)*(0.839)),
                      tt.traj.KC.H.prob = c(0.064*(1-0.902), 0.064*(0.902), (1-0.064)*(1-0.902), (1-0.064)*(0.902)),
                      tt.traj.KC.O.prob = c(0.104*(1-0.920), 0.104*(0.920), (1-0.105)*(1-0.920), (1-0.105)*(0.920)),
                      tt.traj.OW.B.prob = c(0.120*(1-0.811), 0.120*(0.811), (1-0.121)*(1-0.811), (1-0.121)*(0.811)),
                      ...
                      tt.traj.EW.B.prob = c(0.161*(1-0.759), 0.161*(0.759), (1-0.162)*(1-0.759), (1-0.162)*(0.759)),
